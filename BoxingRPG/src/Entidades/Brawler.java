...
public class Brawler extends Hero {
    public Brawler(String name, int maxHP, int power, int defense, int stamina) {
        super(name, maxHP, power, defense, stamina);
    }

    /**
     * Método <b>ATACAR</b> da classe <b>Brawler</b>
    ...
    public void attack(NPC adversario, int choice, boolean specialAttackAvailable) {
        switch(choice) {
            case 1:
                ...
                this.stamina -= 30;
                System.out.println("You unleash a wild combination for " + damage + " damage!");
                break;
            ...
            case 2:
                ...
                int specialDamage;
                if (this.weapon != null) {
                    specialDamage = ((this.power / 5) * 3/2) + this.weapon.getSpecialAttack();
                } else {
                    specialDamage = (this.power / 5) * 3/2;
                }
